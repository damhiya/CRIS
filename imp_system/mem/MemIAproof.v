...
Module MemIA. Section MemIA.
  ...
  Proof using Hstore Hload Hcmp.
    ...
    steps_r. case_bool_decide as Ht; last (exfalso; apply Ht; split; ss); s; clear Ht.
    ...
    inline_r. hrepeat (do 1 hss_r; steps_r). rewrite Hcmp3. steps_r.

    repeat case_bool_decide; simplify_eq.
    { (* Store *)
      steps_r. rewrite bool_decide_eq_true_2; last split; ss.
      inline_r. steps_r. rewrite Hlookup. steps_r.
