...
Module HybMem. Section HybMem.
  ...
  Definition fnsems : fnsemmap :=
    {[Some MemHdr.alloc # (msk_scp scopes msk_true, (None, cfunU alloc));
      Some MemHdr.free  # (msk_scp scopes msk_true, (None, cfunU free));
      Some MemHdr.load  # (msk_scp scopes msk_true, (None, cfunU load));
      Some MemHdr.store # (msk_scp scopes msk_true, (None, cfunU store));
      Some MemHdr.cmp   # (msk_scp scopes msk_true, (None, cfunU cmp));
      Some MemHdr.cas   # (msk_scp scopes msk_true, (None, cfunU cas))]}.
