...
Proof.
  ...
  remember (HMod.scopes md) as scopeS. i. destruct p as [msk sc]. subst.
  unfold wrap_elimI. s.
  ...
  combine_quant msk.
  eapply isim_coind. i.
  destruct a as [msk [nths [ps [pt [sc [SCP [st_src [st_tgt it]]]]]]]]. s.
  iIntros "(Ist & #CIH)".
  ...
  - rewrite SBRed.bind SBRed.ag HIRed.bind_ag. steps_l.
    step. steps_l. by_coind "CIH". eauto.
  ...
  - destruct c.
    {
      ...
      destruct p as [[] ]. iApply isim_inline_tgt.
