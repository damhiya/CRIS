...
(***************
 State-free ISim Notations
 **************)

Notation "E1 '------------------------------------------------------------------□' E2 '------------------------------------------------------------------∗' '-------------------------------isim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs E1 E2 _)
    (isim _ _ _ _ _ RR _ _ itr_src itr_tgt))
    (at level 50, only printing,
     format "E1 '------------------------------------------------------------------□' '//' E2 '------------------------------------------------------------------∗' '//' '-------------------------------isim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}'").

Notation "E1 '------------------------------------------------------------------□' '-------------------------------isim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs E1 Enil _)
    (isim _ _ _ _ _ RR _ _ itr_src itr_tgt))
    (at level 50, only printing,
     format "E1 '------------------------------------------------------------------□' '//' '-------------------------------isim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}'").

Notation "E2 '------------------------------------------------------------------∗' '-------------------------------isim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs Enil E2 _)
    (isim _ _ _ _ _ RR _ _ itr_src itr_tgt))
    (at level 50, only printing,
     format "E2 '------------------------------------------------------------------∗' '//' '-------------------------------isim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}'").

Notation "'------------------------------------------------------------------∗' '-------------------------------isim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs Enil Enil _)
    (isim _ _ _ _ _ RR _ _ itr_src itr_tgt))
    (at level 50, only printing,
     format "'------------------------------------------------------------------∗' '//' '-------------------------------isim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}'").

(***************
 State-free WSim Notations
 **************)

Notation "E1 '------------------------------------------------------------------□' E2 '------------------------------------------------------------------∗' '------------------------------params------------------------------' Ew E g ps pt '-------------------------------wsim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs E1 E2 _)
    (wsim _ _ _ (Ew, E) g _ _ RR ps pt itr_src itr_tgt))
    (at level 50, only printing,
     format "E1 '------------------------------------------------------------------□' '//' E2 '------------------------------------------------------------------∗' '//' '------------------------------params------------------------------' '//' Ew  E  g  ps  pt '//' '-------------------------------wsim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}' ").

Notation "E1 '------------------------------------------------------------------□' '------------------------------params------------------------------' Ew E g ps pt '-------------------------------wsim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs E1 Enil _)
    (wsim _ _ _ (Ew, E) g _ _ RR ps pt itr_src itr_tgt))
    (at level 50, only printing,
     format "E1 '------------------------------------------------------------------□' '//' '------------------------------params------------------------------' '//' Ew  E  g  ps  pt '//' '-------------------------------wsim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}' ").

Notation "E2 '------------------------------------------------------------------∗' '------------------------------params------------------------------' Ew E g ps pt '-------------------------------wsim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs Enil E2 _)
    (wsim _ _ _ (Ew, E) g _ _ RR ps pt itr_src itr_tgt))
    (at level 50, only printing,
     format "E2 '------------------------------------------------------------------∗' '//' '------------------------------params------------------------------' '//' Ew  E  g  ps  pt '//' '-------------------------------wsim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}' ").

Notation "'------------------------------------------------------------------∗' '------------------------------params------------------------------' Ew E g ps pt '-------------------------------wsim-------------------------------' itr_src itr_tgt '{' RR '}'" :=
  (environments.envs_entails (Envs Enil Enil _)
    (wsim _ _ _ (Ew, E) g _ _ RR ps pt itr_src itr_tgt))
    (at level 50, only printing,
     format "'------------------------------------------------------------------∗' '//' '------------------------------params------------------------------' '//' Ew  E  g  ps  pt  '//' '-------------------------------wsim-------------------------------' '//' itr_src '//' '//' itr_tgt '//' '{'  RR  '}' ").
