...
Ltac istep_s := cNormS; _istep_s; simpl; cNormS.

Ltac isteps_s := cNormS; hrepeat (do 1 _istep_s; simpl; cNormS).
...
Ltac istep_t := cNormT; _istep_t; simpl; cNormT.

Ltac isteps_t := cNormT; hrepeat (do 1 _istep_t; simpl; cNormT).
