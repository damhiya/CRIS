...
Section HPSIM.
  ...
  Variant _hpsim' {with_dummy: bool} (is_closed: bool)
  ...
  | hpsim_ret
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, Ret v_src) (st_tgt, Ret v_tgt) fmr
  ...
  | hpsim_call
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Call fn varg) >>= k_src) (st_tgt, trigger (Call fn varg) >>= k_tgt) fmr
  ...
  | hpsim_io
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (IO fn varg) >>= k_src) (st_tgt, trigger (IO fn varg) >>= k_tgt) fmr
  ...
  | hpsim_inline_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Call fn varg) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_inline_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Call fn varg) >>= k_tgt) fmr
  ...
  | hpsim_tau_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, tau;; i_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_tau_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, tau;; i_tgt) fmr
  ...
  | hpsim_take_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Take X) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_choose_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Choose X) >>= k_tgt) fmr
  ...
  | hpsim_choose_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Choose X) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_take_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Take X) >>= k_tgt) fmr
  ...
  | hpsim_sput_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (SPut k v) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_sput_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (SPut k v) >>= k_tgt) fmr
  ...
  | hpsim_sget_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (SGet k) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_sget_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (SGet k) >>= k_tgt) fmr
  ...
  | hpsim_assume_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Assume iP) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_guarantee_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Guarantee iP) >>= k_tgt) fmr
  ...
  | hpsim_guarantee_src
      ...
      (K: forall fmr0 (NEW: Own fmr0 ⊢ #=> FMR),
          hpsimi true pt nths (st_src, k_src tt) (st_tgt, i_tgt) fmr0)
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Guarantee iP) >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_assume_tgt
      ...
      (K: forall fmr0 (NEW: Own fmr0 ⊢ #=> FMR),
          hpsimi ps true nths (st_src, i_src) (st_tgt, k_tgt tt) fmr0)
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Assume iP) >>= k_tgt) fmr
  ...
  | hpsim_spawn
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Spawn fn arg) >>= k_src) (st_tgt, trigger (Spawn fn arg) >>= k_tgt) fmr
  ...
  | hpsim_yield
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger (Yield tid) >>= k_src) (st_tgt, trigger (Yield tid) >>= k_tgt) fmr
  ...
  | hpsim_tid_src
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, trigger Tid >>= k_src) (st_tgt, i_tgt) fmr
  ...
  | hpsim_tid_tgt
    ...
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger Tid >>= k_tgt) fmr
  ...
  | hpsim_call_none
      ...
      (K: hpsimi ps true nths (st_src, i_src) (st_tgt, triggerNB >>= k_tgt) fmr)
    :
    _hpsim' is_closed hpsimc hpsimi ps pt nths (st_src, i_src) (st_tgt, trigger (Call fn varg) >>= k_tgt) fmr
  ...
  | hpsim_progress
    ...
    :
    _hpsim' is_closed hpsimc hpsimi true true nths sti_src sti_tgt fmr
  .
  Arguments _hpsim' {with_dummy} is_closed hpsimc {R} RR hpsimi.

  Inductive _hpsim {with_dummy} is_closed hpsim R RR ps pt nths sti_src sti_tgt fmr : Prop
    :=
  | hpsim_intro (IN: hsupd (@_hpsim' with_dummy is_closed hpsim R RR (@_hpsim with_dummy is_closed hpsim R RR) ps pt nths sti_src sti_tgt) fmr) 
  .

  Definition hpsim is_closed {R} RR := paco8 (@_hpsim false is_closed) bot8 R RR.
  (* Definition hpsim_closed {R} RR := paco8 (@_hpsim false true) bot8 R RR. *)

  Lemma _hpsim_tarski with_dummy is_closed hpsim R RR rel
    (FIX: forall ps pt nths sti_src sti_tgt fmr
            (IN: hsupd (@_hpsim' with_dummy is_closed hpsim R RR rel ps pt nths sti_src sti_tgt) fmr),
          rel ps pt nths sti_src sti_tgt fmr)
    :
    @_hpsim with_dummy is_closed hpsim R RR <6= rel.
  Proof.
    fix self 7. i.
  ...
  Lemma _hpsim'_mon with_dummy is_closed r r' R RR s s'
    ps pt nths sti_src sti_tgt fmr
    (REL: @_hpsim' with_dummy is_closed r R RR s ps pt nths sti_src sti_tgt fmr)
    (LEr: r <8= r')
    (LEs: s <6= s')
    :
    @_hpsim' with_dummy is_closed r' R RR s' ps pt nths sti_src sti_tgt fmr.
  Proof.
    ii. destruct REL; des; esplits; eauto.
    24: { econs 24; eauto. }
    all: econs; esplits; eauto.
  Qed.
  
  Lemma _hpsim_mon with_dummy is_closed : monotone8 (@_hpsim with_dummy is_closed).
  Proof.
    ii. eapply _hpsim_tarski, IN.
    i. econs. eauto using hsupd_mon, _hpsim'_mon.
  Qed.

  Lemma _hpsim_mon_auto with_dummy is_closed r r' R RR
    ps pt nths sti_src sti_tgt fmr
    (REL: @_hpsim with_dummy is_closed r R RR ps pt nths sti_src sti_tgt fmr)
    (LEr: r <8= r')
    :
    @_hpsim with_dummy is_closed r' R RR ps pt nths sti_src sti_tgt fmr.
  ...
  Definition hpsim_body is_closed ps pt nths sti_src sti_tgt fmr :=
    forall
    ...
    @hpsim is_closed _ hpsim_tail ps pt nths sti_src sti_tgt fmr.

  Definition hpsim_fun is_closed (i_src: itree hmodE Any.t) (i_tgt: itree hmodE Any.t):  Prop :=
    forall nths st_src st_tgt fmr
           (INV: Own fmr ⊢ #=> Ist nths st_src st_tgt),
      hpsim_body is_closed false false nths (st_src, i_src) (st_tgt, i_tgt) fmr.
  ...
  Lemma _hpsim_flag_mon with_dummy is_closed r R RR (ps pt ps' pt': bool) nths st_src st_tgt fmr
    (SIM: @_hpsim with_dummy is_closed r R RR ps pt nths st_src st_tgt fmr)
    (LES: ps -> ps')
    (LET: pt -> pt')
    :
    @_hpsim with_dummy is_closed r R RR ps' pt' nths st_src st_tgt fmr.
  Proof.
  ...
  Lemma hpsim_flag_mon R RR is_closed (ps pt ps' pt': bool) nths st_src st_tgt fmr
    (SIM: @hpsim is_closed R RR ps pt nths st_src st_tgt fmr)
    (LES: ps -> ps')
    (LET: pt -> pt')
    :
    hpsim is_closed RR ps' pt' nths st_src st_tgt fmr.
  Proof.
  ...
  Lemma hpsim_progress_flag with_dummy is_closed R RR r g nths st_src st_tgt fmr
    (SIM: gpaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)) g g R RR false false nths st_src st_tgt fmr)
    :
    gpaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)) r g R RR true true nths st_src st_tgt fmr.
  Proof.
  ...
  Definition hpsimC with_dummy is_closed hpsim R RR ps pt nths sti_src sti_tgt fmr :=
    hsupd (@_hpsim' with_dummy is_closed hpsim R RR (hpsim R RR) ps pt nths sti_src sti_tgt) fmr.
  
  Lemma hpsimC_mon with_dummy is_closed : monotone8 (@hpsimC with_dummy is_closed).
  Proof.
    ii. specialize (IN H). des.
    destruct IN; econs; esplits; eauto; try by esplits; eauto.
  Qed.

  Lemma hpsimC_spec with_dummy is_closed:
    (@hpsimC with_dummy is_closed) <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
  ...
  Variant hpsim_flagC 
    (r: forall (R: Type) (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp),  bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop)
  ...
  Lemma hpsim_flagC_spec with_dummy is_closed:
    hpsim_flagC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
    eapply wrespect8_uclo; eauto with paco.
  ...
  Lemma hpsim_flag_down with_dummy is_closed R RR r g ps pt nths st_src st_tgt fmr
    (SIM: gpaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)) r g R RR false false nths st_src st_tgt fmr)
    :
    gpaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)) r g R RR ps pt nths st_src st_tgt fmr.
  Proof. 
  ...
  Variant hpsim_bindC (r: forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop):
  ...
  | hpsim_bindC_intro
      ...
      R RR k_src k_tgt
      (SIMK: forall nths0 st_src0 st_tgt0 vret_src vret_tgt fmr0
  ...
  Lemma hpsim_bindC_mon
        ...
        (LEr: r1 <8= r2)
    :
    hpsim_bindC r1 <8= hpsim_bindC r2
  .
  Proof. ii. destruct PR; econs; et. Qed.

  Lemma hpsim_bindC_wrespectful with_dummy is_closed:
    wrespectful8 (@_hpsim with_dummy is_closed) hpsim_bindC.
  Proof.
    ...
    exploit SIMK; eauto.
    i. apply GF in x0.
    eapply (_hpsim_flag_mon _ _ _ _ _ _ _ ps0 pt0) in x0; try by i; clarify.

    destruct x0. eapply hsupd_update in IN; eauto.
    eapply _hpsim_mon_auto; eauto using rclo8.
  Qed.

  Lemma hpsim_bindC_spec with_dummy is_closed:
    hpsim_bindC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
    intros. eapply wrespect8_uclo; eauto with paco.
    apply hpsim_bindC_wrespectful.
  Qed.

  Variant hpsim_extendC (r: forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop):
    forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop
  :=
  | hpsim_extendC_intro
  ...
  Lemma hpsim_extendC_mon
        ...
        (LEr: r1 <8= r2)
    :
    hpsim_extendC r1 <8= hpsim_extendC r2
  .
  Proof. ii. destruct PR; econs; et. Qed.

  Lemma hpsim_extendC_compatible with_dummy is_closed:
    compatible8 (@_hpsim with_dummy is_closed) hpsim_extendC.
  Proof.
  ...
  Lemma hpsim_extendC_spec with_dummy is_closed:
    hpsim_extendC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
  ...
  Variant hpsim_wfC (r: forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop):
    forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop
  :=
  | hpsim_wfC_intro
      ps pt nths R RR sti_src sti_tgt fmr
      (SIM: URA.wf fmr -> r R RR ps pt nths sti_src sti_tgt fmr)
     :
  ...
  Lemma hpsim_wfC_mon
        ...
        (LEr: r1 <8= r2)
    :
    hpsim_wfC r1 <8= hpsim_wfC r2
  .
  Proof.
    ii. destruct PR. econs; eauto using hsupd_mon.
  Qed.

  Lemma hpsim_wfC_compatible with_dummy is_closed:
    compatible8 (@_hpsim with_dummy is_closed) hpsim_wfC.
  Proof.
  ...
  Lemma hpsim_wfC_spec with_dummy is_closed:
    hpsim_wfC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
  ...
  Variant hpsim_updateC (r: forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop):
    forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop
  :=
  | hpsim_updateC_intro
      ps pt nths R RR sti_src sti_tgt fmr
  ...
  Lemma hpsim_updateC_mon
        ...
        (LEr: r1 <8= r2)
    :
    hpsim_updateC r1 <8= hpsim_updateC r2
  .
  Proof.
    ii. destruct PR. econs; eauto using hsupd_mon.
  Qed.

  Lemma hpsim_updateC_compatible with_dummy is_closed:
    compatible8 (@_hpsim with_dummy is_closed) hpsim_updateC.
  Proof.
  ...
  Lemma hpsim_updateC_spec with_dummy is_closed:
    hpsim_updateC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof. 
  ...
  Variant hpsim_frameC (r: forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop):
    forall R (RR: nat -> (alist key Any.t) * R -> (alist key Any.t) * R -> iProp), bool -> bool -> nat -> (alist key Any.t) * itree hmodE R -> (alist key Any.t) * itree hmodE R -> Σ -> Prop
  :=
  | hpsim_frameC_intro
      ps pt nths R RR sti_src sti_tgt fmr fmrc (CTX: iProp)
      (SIM: r R (fun n s t => CTX -* RR n s t) ps pt nths sti_src sti_tgt fmr)
  ...
  Lemma hpsim_frameC_mon
        ...
        (LEr: r1 <8= r2)
    :
    hpsim_frameC r1 <8= hpsim_frameC r2
  .
  Proof.
    ii. destruct PR. econs; eauto using hsupd_mon.
  Qed.
  
  Lemma hpsim_frameC_compatible with_dummy is_closed:
    compatible8 (@_hpsim with_dummy is_closed) hpsim_frameC.
  Proof.
  ...
  Lemma hpsim_frameC_spec with_dummy is_closed:
    hpsim_frameC <9= gupaco8 (@_hpsim with_dummy is_closed) (cpn8 (@_hpsim with_dummy is_closed)).
  Proof.
