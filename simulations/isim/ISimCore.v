...
(***** isim lemmas *****)
  ...
  (* Simulation rules *)
  Lemma isim_ret
    r g ps pt {R} RR nths st_src st_tgt v_src v_tgt
  :
    bi_entails
  ...
  Lemma isim_tau_src
    r g ps pt {R} RR nths st_src st_tgt i_src i_tgt
  :
    bi_entails
  ...
  Lemma isim_call 
    r g ps pt {R} RR nths st_src st_tgt k_src k_tgt fn varg
  :
    bi_entails
  ...
  Lemma isim_sput_src
    r g ps pt {R} RR  k v nths st_src st_tgt k_src i_tgt
    :
    bi_entails
  ...
  Lemma isim_sput_src_sandbox
    r g ps pt {R} RR  k v nths st_src st_tgt k_src i_tgt scopes
    :
    In k.1 scopes ->
    bi_entails
      (@isim r g R RR true pt nths (alist_upd k v st_src, k_src tt) (st_tgt, i_tgt))
  ...
  Lemma isim_sput_tgt
    r g ps pt {R} RR k v nths st_src st_tgt i_src k_tgt
    :
    bi_entails
  ...
  Lemma isim_sput_tgt_sandbox
    r g ps pt {R} RR k v nths st_src st_tgt i_src k_tgt scopes
    :
    In k.1 scopes ->
    bi_entails
      (@isim r g R RR ps true nths (st_src, i_src) (alist_upd k v st_tgt, k_tgt tt))
  ...
  Lemma isim_sget_src
    r g ps pt {R} RR k nths st_src st_tgt k_src i_tgt
    :
    bi_entails
  ...
  Lemma isim_sget_src_sandbox
    r g ps pt {R} RR k nths st_src st_tgt k_src i_tgt scopes
    :
    In k.1 scopes ->
    bi_entails
      (@isim r g R RR true pt nths (st_src, k_src (or_else (alist_find k st_src) tt↑)) (st_tgt, i_tgt))
  ...
  Lemma isim_sget_tgt
    r g ps pt {R} RR k nths st_src st_tgt i_src k_tgt
    :
    bi_entails
  ...
  Lemma isim_sget_tgt_sandbox
    r g ps pt {R} RR k nths st_src st_tgt i_src k_tgt scopes
    :
    In k.1 scopes ->
    bi_entails
      (@isim r g R RR ps true nths (st_src, i_src) (st_tgt, k_tgt (or_else (alist_find k st_tgt) tt↑)))
  ...
  Lemma isim_Assume_src
    r g ps pt {R} RR iP nths st_src st_tgt k_src i_tgt 
    :
    bi_entails
  ...
  Lemma isim_Assume_tgt
    r g ps pt {R} RR iP nths st_src st_tgt i_src k_tgt 
    :
    bi_entails
  ...
  Proof.
    ...
    { instantiate (1:= (@isim r g R RR ps true nths (st_src, i_src) (st_tgt, k_tgt tt))).
  ...
  Proof.
    uiprop. i. des. subst.
    guclo hpsimC_spec. econs; esplits; eauto. econs; eauto; i.
    { instantiate (1:= (@isim r g R RR true pt nths (st_src, k_src ()) (st_tgt, i_tgt))).
      eapply iProp_Own in H0.
      iIntros "[A B]". iPoseProof (H0 with "A") as "A". iFrame. iStopProof.
      eapply iProp_Own. uiprop. eauto.
    }
  ...
  Lemma isim_spawn
    r g ps pt {R} RR nths st_src st_tgt k_src k_tgt fn arg
  : 
    bi_entails
  ...
  Lemma isim_yield 
    r g ps pt {R} RR nths st_src st_tgt k_src k_tgt tid
  :
    bi_entails
      ((Ist nths st_src st_tgt) ∗
  ...
  Lemma isim_tid_src
    r g ps pt {R} RR nths st_src st_tgt k_src i_tgt
  :
    bi_entails
  ...
  Lemma isim_triggerUB_src_trigger
    r g {R} RR ps pt nths st_src st_tgt i_tgt
    :
    bi_entails
      (⌜True⌝)
  ...
  Lemma isim_triggerNB_trigger
    r g {R} RR ps pt nths st_src st_tgt i_src
    :
    bi_entails
      (⌜True⌝)
  ...
  Lemma isim_coind (r g: rel) A P RA RRA psA ptA nthsA srcA tgtA
    ...
    forall (a:A),
      bi_entails
        (P a)
        (@isim r g (RA a) (RRA a) (psA a) (ptA a) (nthsA a) (srcA a) (tgtA a)).
  Proof.
    ...
    guclo hpsim_updateC_spec. econs; ii; esplits; eauto.
    specialize (COIND
                  (fun R RR ps pt nths src tgt =>
                     g R RR ps pt nths src tgt ∨
                       ∃ a, P a ∗ ⌜@existT Type (fun _ => _) R (RR,ps,pt,nths,src,tgt) =
                               existT (RA a) (RRA a,psA a,ptA a,nthsA a,srcA a,tgtA a)⌝)%I a).
    rr in COIND. autorewrite with iprop in COIND.
    eapply gpaco8_mon. eapply COIND; eauto.
    - rr. autorewrite with iprop. exists ε, r2. r_solve.
      esplits; eauto. eapply Own_iProp, URA.wf_unit.
      iIntros "_". iModIntro. iSplitL "".
      + iIntros (R RR ps pt nths src tgt) "H". iFrame.
...
Section HYPER.
  ...
  Definition ksimH
    ...
    :=
    ∀ RR, RRH RR -∗ ∃ II, IIH II ∗ ksim fl_src fl_tgt Ist my_tid r g II RR ps pt kt_src kt_tgt.
  ...
  Definition cwpreH r g {I R}
    ...
    fun IH =>
      (∃ RR, RRH RR ∗
       cimply (cwpre fl_src fl_tgt Ist my_tid r g RR ps pt kt_src kt_tgt) IH)%I.
  ...
  Lemma cimplyH_strengthen {I} IIH JJH:
    ⊢ (∀ II, JJH II -∗ IIH II) -∗ @cimplyH I IIH JJH.
  Proof.
    iIntros "SUB". iIntros (?) "JJ".
    iExists JJ. iSpecialize ("SUB" with "JJ"). iFrame.
    iApply cimply_refl.
  Qed.
  ...
  Proof.
    iIntros (?) "RR".
    iExists (cwpre _ _ _ _ r g RR ps pt kt_src kt_tgt).
    iSplitL "RR".
    - iExists RR. iFrame.
      iIntros (? ? ? ? ?). eauto.
    - iApply cwpre_sound.
  ...
  Lemma ksimH_bind
    r g ps pt {I T R} IIH RRH j_src j_tgt k_src k_tgt
    :

    (@ksimH r g I T IIH (cwpreH r g RRH false false k_src k_tgt) ps pt j_src j_tgt)
    ⊢
    @ksimH r g I R IIH RRH ps pt (fun x => j_src x >>= k_src) (fun x => j_tgt x >>= k_tgt).
  Proof.
    iIntros "SIM".
    iApply ksimH_bind_aux.
    iSplitL "SIM".
    - iIntros (?) "RR". iSpecialize ("SIM" with "RR").
      iDestruct "SIM" as (II) "SIM".
      iExists II. iFrame.
    - iIntros (?) "RR". iExists _.
      iSplitL "RR".
      + iExists RR. iFrame. iApply cimply_refl.
      + iIntros (? ? ? ? ?) "SIM". eauto.
  Qed.
