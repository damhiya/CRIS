...
Module RRSI. Section RRSI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some RRSHdr.init # (msk_real (msk_scp scp msk_true), (None, cfunU init));
      Some RRSHdr._spawn # (msk_real (msk_scp scp msk_true), (None, cfunU inner_spawn));
      Some RRSHdr.spawn # (msk_real (msk_scp scp msk_true), (None, cfunU spawn));
      Some RRSHdr.yield # (msk_real (msk_scp scp msk_true), (None, cfunU yield));
      Some RRSHdr.yield_global # (msk_real (msk_scp scp msk_true), (None, cfunU yield_global));
      Some RRSHdr.get_tid # (msk_real (msk_scp scp msk_true), (None, cfunU get_tid))]}.
