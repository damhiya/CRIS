...
Module NDSI. Section NDSI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some NDSHdr.init # (msk_real (msk_scp scp msk_true), (None, cfunU init));
      Some NDSHdr._spawn # (msk_real (msk_scp scp msk_true), (None, cfunU inner_spawn));
      Some NDSHdr.spawn # (msk_real (msk_scp scp msk_true), (None, cfunU spawn));
      Some NDSHdr.yield # (msk_real (msk_scp scp msk_true), (None, cfunU yield));
      Some NDSHdr.yield_global # (msk_real (msk_scp scp msk_true), (None, cfunU yield_global));
      Some NDSHdr.join # (msk_real (msk_scp scp msk_true), (None, cfunU join));
      Some NDSHdr.get_tid # (msk_real (msk_scp scp msk_true), (None, cfunU get_tid))]}.
