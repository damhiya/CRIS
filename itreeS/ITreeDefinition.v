...
Definition subst {E : iEvent} {T U: Type} (k : T -> itree E U)
  : itree E T -> itree E U :=
  cofix _subst (t : itree E T) : itree E U :=
...
Definition bind {E : iEvent} {T U: Type} (t : itree E T) (k : T -> itree E U)
  : itree E U :=
  subst k t.
...
Definition iter {E : iEvent} {I R: Type}
           (step : I -> itree E (I + R)%type) : I -> itree E R :=
...
Definition map {E} {R S: Type} (f : R -> S)  (t : itree E R) : itree E S :=
  bind t (fun x => Ret (f x)).

(** Atomic itrees triggering a single event. *)
Definition trigger {E : iEvent} : E ~> itree E :=
...
Definition ktree (E: iEvent) (A B: Type) :=
  A -> itree E B.
...
Lemma hexploit_mp: forall (P: Type) (Q: Type), P -> (P -> Q) -> Q.
