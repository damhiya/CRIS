...
Module SystemI. Section SystemI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some SystemHdr._spawn # (msk_real (msk_scp scopes msk_true), (None, cfunU _spawn));
      Some SystemHdr.spawn # (msk_real (msk_scp scopes msk_true), (None, cfunU spawn));
      Some SystemHdr.get_tid # (msk_real (msk_scp scopes msk_true), (None, cfunU get_tid));
      Some SystemHdr.yield # (msk_real (msk_scp scopes msk_true), (None, cfunU yield));
      Some SystemHdr.alloc # (msk_real (msk_scp scopes msk_true), (None, cfunU alloc));
      Some SystemHdr.write # (msk_real (msk_scp scopes msk_true), (None, cfunU write));
      Some SystemHdr.read # (msk_real (msk_scp scopes msk_true), (None, cfunU read))]}.
