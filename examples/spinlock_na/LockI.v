...
Module SpinLockI. Section SpinLockI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some SpinLockHdr.newlock # (msk_real (msk_scp scopes msk_true), (None, cfunU newlock));
      Some SpinLockHdr.acquire # (msk_real (msk_scp scopes msk_true), (None, cfunU acquire));
      Some SpinLockHdr.release # (msk_real (msk_scp scopes msk_true), (None, cfunU release))]}.
