...
Module PQueueI. Section PQueueI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some PQueueHdr.new        # (msk_real (msk_scp scopes msk_true), (None, cfunU new));
      Some PQueueHdr.add        # (msk_real (msk_scp scopes msk_true), (None, cfunU add));
      Some PQueueHdr.remove_min # (msk_real (msk_scp scopes msk_true), (None, cfunU remove_min))]}.
