...
Module StackI. Section StackI.
  ...
  Definition fnsems : fnsemmap :=
    {[Some StackHdr.new_stack # (msk_real (msk_scp scopes msk_true), (None, cfunU new_stack));
      Some StackHdr.push      # (msk_real (msk_scp scopes msk_true), (None, cfunU push));
      Some StackHdr.pop       # (msk_real (msk_scp scopes msk_true), (None, cfunU pop))]}.
